...
jobs_clean |> 
  ...
  ggplot() + 
  geom_col(aes(x = occupation, y = earnings_by_group, fill = sex), 
           position = "dodge") + 
...
jobs_clean |>
  ...
  scale_color_manual(values = c("magenta3", "blue3")) +
  coord_flip() + 
  theme_classic()
```
...
ggplot(data = subset_jobs) + 
  geom_linerange(aes(y = occupation, 
                 ...
                 color = "black") +
  geom_point(aes(x = total_earnings_male, y = occupation), color = "blue3") +
  geom_point(aes(x = total_earnings_female, y = occupation), color = "magenta3") +
